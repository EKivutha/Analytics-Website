...
class NewStockvsProduct extends React.Component {
  constructor(props) {
    super(props);
...
NewStockvsProduct.defaultProps = {
  title: "New Stock vs Product",
  chartData: {
    datasets: [
      {
    ...
    labels: ["NewStock", "Products"]
  }
};

export default NewStockvsProduct;
