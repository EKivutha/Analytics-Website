...
class RemovedStockvsProduct extends React.Component {
  constructor(props) {
    super(props);
...
RemovedStockvsProduct.propTypes = {
  /**
...
RemovedStockvsProduct.defaultProps = {
  title: "Removed Stock vs Product",
  chartData: {
    datasets: [
      {
    ...
    labels: ["Product", "Removed Stock"]
  }
};

export default RemovedStockvsProduct;
