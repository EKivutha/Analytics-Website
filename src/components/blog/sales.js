...
class SalesvsTargets extends React.Component {
  constructor(props) {
    super(props);
...
SalesvsTargets.defaultProps = {
  title: "Sales Target vs Sales Made",
  chartData: {
    datasets: [
      {
    ...
    labels: ["Sales Target", "Sales Made"]
  }
};

export default SalesvsTargets;
