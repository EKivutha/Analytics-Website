...
class VisitTargetsvsMade extends React.Component {
  constructor(props) {
    super(props);
...
VisitTargetsvsMade.defaultProps = {
  title: "Visit Targets vs Visits Made",
  chartData: {
    datasets: [
      {
    ...
    labels: ["Visit Targets", "Visits Made"]
  }
};

export default VisitTargetsvsMade;
