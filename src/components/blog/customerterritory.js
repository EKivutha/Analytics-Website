...
class ActiveCustomervsTerritory extends React.Component {
  constructor(props) {
    super(props);
...
ActiveCustomervsTerritory.propTypes = {
  /**
...
ActiveCustomervsTerritory.defaultProps = {
  title: "Active Customer vs Territory",
  chartData: {
    datasets: [
      {
    ...
    labels: ["Territorry", "Active Customer"]
  }
};

export default ActiveCustomervsTerritory;
